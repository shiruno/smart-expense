...
function IncomeManager({ expenses, setEditingExpense, deleteExpense, resetIncome }) {
  ...
  return (
    <div className="income-manager" style={{ marginTop: '20px' }}>
      ...
      <div style={{ marginBottom: '10px' }}>
        <button onClick={handleReset} style={{ backgroundColor: 'orange', color: 'white' }}>Reset All Income</button>
      </div>
